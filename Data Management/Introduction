...
<a>Development</a> — Crafting strategies & frameworks that define how data should be managed.

<a>Execution</a> — Implementing the strategies through tools, technologies, and processes.

<a>Supervision</a> — Monitoring & governing data management activities to ensure compliance & effectiveness.
